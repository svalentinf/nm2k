    ...
    <header>
        ...
        <div class="status" :class="{ connected: isConnected }">
            ...
            <button v-if="!isConnected" class="btn btn-primary btn-sm"
                ...
                <i class="fas fa-plug" :class="isConnecting?'btn-fa-plug-circle-bolt':'fa-plug'"></i> Connect
            </button>
            <button v-else-if="isConnecting" class="btn btn-primary btn-sm"
                    @click="$emit('connectWebSocket')">
                <i class="fas fa-plug-circle-bolt" :class="isConnecting?'btn-fa-plug-circle-bolt':'fa-plug'"></i> Connecting
            </button>
